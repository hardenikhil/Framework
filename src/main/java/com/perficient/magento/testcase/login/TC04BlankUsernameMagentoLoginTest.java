...
/**
 * @author pooja.manna
 * Testcase for blank username for login
 */
...
public class TC04BlankUsernameMagentoLoginTest extends TestCaseBase {

	@Test(groups = { "firefox", "IEWin32", "ChromeWin32", "browserPercentageSpecified" })
	public void testSearch() throws Exception {
		// Load the username and password from
		// 'testdata_TC04BlankUserNameMagentoLogin.properties' file using 'TestData.java'
		// class
